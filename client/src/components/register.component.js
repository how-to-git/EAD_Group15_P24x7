...
const Register = ({ userData }) => {
  ...
  if (status === 302 && !properties.verify && verifyAccount)
  ...
  const Register = (e) => {
    ...
    async function submitData() {
      await axios
        .post(`${SERVER_URL}/account/register`, register, {
    ...
    if (properties.honeypot) return;
      ...
      EMAIL_VAL.test(String(register.email).toLocaleLowerCase()) === false
    ) {
      setNotification(
        NOTIFICATION_TYPES.DANGER,
    ...
    } else if (register.email.length < 6 || register.email.length > 60) {
      setNotification(
        NOTIFICATION_TYPES.DANGER,
      ...
      register.password.length > 60 ||
      register.confirmPassword.length < 6 ||
      register.confirmPassword.length > 60
    ) {
      setNotification(
        NOTIFICATION_TYPES.DANGER,
      ...
      document
        .getElementById(
          register.password.length < 6 || register.password.length > 60
            ? "userPassword"
            : "userConfirmPassword"
        )
        .focus();
  ...
  const sendLink = (e) => {
    ...
    async function submitData() {
      ...
      btn.classList.add("disabled");
      await axios
        .post(`${SERVER_URL}/account/verify`, null, {
          headers: { "XSRF-TOKEN": getCSRFToken() },
          withCredentials: true,
        })
        .then((res) =>
  ...
  return properties.verify ? (
    <div id="form">
      <div className="form__contact">
        ...
        <div className="form">
          <h4 className="mt-20 mb-20 isCentered">
            Please check your email ({email ? email : register.email}) to
            confirm your account.
          </h4>
          <hr />
          <h4 className="mt-20 mb-20 isCentered">
            If {email ? email : properties.email} is not your email address,
            click on the back button and enter the correct one.
          </h4>
          <h4 className="mt-20 mb-20 isCentered">
            If you don't receive the e-mail in 5 minutes, please check your spam
            folder or click the resend button.
          </h4>
            ...
            <div className="m-10">
              <div className="contact__infoField">
                ...
                <input
                  ...
                  maxLength="60"
                  onChange={(event) =>
                    handleRegister("email", event.target.value)
                  }
              ...
              <div className="m-10">
                <div className="contact__infoField">
                  ...
                  <input
                    ...
                    maxLength="60"
                    onChange={(event) =>
                      handleRegister("password", event.target.value)
                    }
              ...
              <div className="m-10">
                <div className="contact__infoField">
                  ...
                  <input
                    ...
                    maxLength="60"
                    onChange={(event) =>
                      handleRegister("confirmPassword", event.target.value)
                    }
