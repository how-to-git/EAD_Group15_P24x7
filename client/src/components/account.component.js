...
const Account = ({ userData }) => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < otp1.length; i++) {
      otp1[i].setAttribute("maxlength", 1);
      otp1[i].setAttribute("type", "text");
      otp1[i].setAttribute("pattern", "[0-9]");
      otp1[i].setAttribute("autocomplete", "off");
      otp1[i].setAttribute("inputmode", "numeric");
    ...
    for (let i = 0; i < otp2.length; i++) {
      otp2[i].setAttribute("maxlength", 1);
      otp2[i].setAttribute("type", "text");
      otp2[i].setAttribute("pattern", "[0-9]");
      otp2[i].setAttribute("autocomplete", "off");
      otp2[i].setAttribute("inputmode", "numeric");
...
5. ${codes[4]}		10. ${codes[9]}`;
  ...
  const changePassword = (e) => {
    ...
    if (
      ...
      document
        .getElementById(
          password.oldPassword.length < 6 || password.oldPassword.length > 60
            ? "old-password"
            : password.newPassword.length < 6 ||
              password.newPassword.length > 60
            ? "new-password"
  ...
  const sendOTP = (e) => {
    ...
    async function sendToken() {
      ...
      passwordBtn.innerHTML = "Send Verification Code";
  ...
  const RegenerateToken = (e) => {
    ...
    if (!security["2FA"])
      setNotification(
        ...
        "Backup Codes are only eligle in Multi Factor Authentication (MFA) Users"
      );
    else generateToken();
  };
        ...
        <div className="form__contact">
          ...
          <div className="form">
            <div className="m-10">
              ...
              <Tooltip
                placement="top"
                title="Two-Factor Authentication (2FA) is a good way to add an extra layer of security to your account to make sure that only you have the ability to log in."
                arrow
              >
                <span>
          ...
          <p className="isCentered mt-20 mb-20">
            Copyright &copy; Productivity 24x7
          </p>
        </div>
      </div>
      ...
      <div id="password-bg" className="modal hiddenModal">
        <div id="password-modal" className="modal__container hiddenModal">
          <div className="modal__title">
            <span
              className="modal__closeFireUI modal__closeBtn"
              ...
              <li>
                ...
                <blockquote className="mt-20">
                  ...
                  <p className="mt-10">
                    ...
                    and will be valid for only <b>5 (five) minutes</b>.
                  </p>
                  <p className="mt-10">
                    <b>
                      Note: Once you enable 2 Factor Authentication (2FA), you
                      will be prompted to enter verification code on every login
                      session.
                    </b>
                  </p>
                </blockquote>
                ...
                <form onSubmit={VerifyOTP}>
                  <div className="m-10">
                    <div className="contact__infoField">
                      ...
                      <div
                        id="otp1"
                        className="otp flex justify-center isCentered"
                      >
                        <input id="token-1" />
                        <input id="token-2" />
                        <input id="token-3" />
          ...
          <div id="backup-code-modal" className="modal__container hiddenModal">
            <div className="modal__title">
              <span
                className="modal__closeFireUI modal__closeBtn"
                onClick={() =>
                  closeModal("backup-code-bg", "backup-code-modal")
                }
              >
                &times;
              </span>
