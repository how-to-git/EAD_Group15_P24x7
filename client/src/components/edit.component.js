            ...
            <div className="m-10">
              <div className="contact__infoField">
                ...
                <input
                  ...
                  className="contact__inputField"
                  maxLength="60"
                  onChange={(event) => handleData("title", event.target.value)}
                  value={data.title}
                  required
                />
                <span className="contact__onFocus"></span>
          ...
          <div className="m-10">
            <div className="contact__infoField">
              ...
              <Select
                id="label"
                value={data.label}
                onChange={(event) => handleData("label", event.target.value)}
