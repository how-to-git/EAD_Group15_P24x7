...
const VerifyAccount = () => {
  ...
  useEffect(() => {
    async function validateData() {
      await axios
        .get(`${SERVER_URL}/account/verify`, {
          params: { id, token, type: "accountVerification" },
        })
  ...
  return properties.isLoading ? (
    ...
    <div id="form">
      ...
      <div className="get_in_touch mt-20">
        <h1>Oops! Looks like the link is expired or invalid.</h1>
      </div>
    </div>
  );
};
